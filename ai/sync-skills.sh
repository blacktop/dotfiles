...
# Claude Code looks for skills at $CLAUDE_CONFIG_DIR/skills/ (defaults to ~/.claude/skills/)
# Symlink each config dir to the unified location so skills aren't duplicated on disk
for claude_dir in "$HOME/.claude" "$HOME/.claude-team"; do
