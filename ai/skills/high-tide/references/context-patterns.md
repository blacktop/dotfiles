...
- Use `scripts/context_percent.py` to normalize measured payloads or status snippets into a used percentage. The helper should reject unrelated percentages such as rate-limit usage and convert explicit remaining-context values into used-context values.
